...
//			StringValue("UMa"/*"UMi-StreetCanyon"*/)); // with antenna height of 10 m
  ...
  ueMobility.SetMobilityModel ( "ns3::ConstantSpeedZigzagBoxMobilityModel",
...
//  mmWaveHelper->EnableTraces();
  ...
  if(!conf.outputDir.empty() && !conf.animFile.empty())
    {
      AnimationInterface anim(conf.outputDir + "/" + conf.animFile);
